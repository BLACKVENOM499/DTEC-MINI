...
`.trim();
        ...
        const templateButtons = [
            { buttonId: `${prefix}menu`, buttonText: { displayText: "🔙 MAIN MENU" }, type: 1 },
            { buttonId: `${prefix}ping`, buttonText: { displayText: "👤 OWNER" }, type: 1 }
        ];
        ...
        await socket.sendMessage(sender, { text: '*❌ ᴇʀʀොʀ ꜰᴇᴛᴄʜɪɴɢ ꜱʏꜱᴛᴇᴍ ɪɴꜰො!*' }, { quoted: msg });
    }
    break;
}
case 'activesessions':
...
case 'menu': {
  ...
  try {
    ...
    const greetings = curHr < 12 ? 'ɢᴏᴏᴅ ᴍොʀɴɪɴɢ ⛅' : curHr < 18 ? 'ɢᴏᴏᴅ ᴀꜰᴛᴇʀɴොොɴ 🌞' : 'ɢᴏᴏᴅ ᴇᴠᴇɴɪɴɢ 🌙';
...
│ ⚡ *ᴠᴇʀꜱɪොɴ* ➠ ${config.BOT_VERSION || '1.0.0'}
│
╰───────────────────────💠
...
> *ᴘොᴡᴇʀᴇᴅ ʙʏ ʟɪᴛᴇ x ꜱʏꜱᴛᴇᴍ*
`.trim();

    // Quick Reply Buttons
    const templateButtons = [
        { buttonId: `${prefix}download`, buttonText: { displayText: "📂 ᴅොᴡɴʟොᴀᴅ ᴍᴇɴᴜ" }, type: 1 },
        { buttonId: `${prefix}creative`, buttonText: { displayText: "🎨 ᴄʀᴇᴀᴛɪᴠᴇ ᴍᴇɴᴜ" }, type: 1 },
        { buttonId: `${prefix}tools`, buttonText: { displayText: "🛠️ ᴛොොʟꜱ ᴍᴇɴᴜ" }, type: 1 },
    ...
    try { await socket.sendMessage(sender, { text: '❌ ꜰᴀɪʟᴇᴅ ᴛො ꜱʜොᴡ ᴍᴇɴᴜ.' }, { quoted: msg }); } catch(e){}
  }
  break;
}
...
`.trim();
    ...
    const templateButtons = [
        ...
        { buttonId: `${prefix}creative`, buttonText: { displayText: "🎨 ᴄʀᴇᴀᴛɪᴠᴇ ᴍᴇɴᴜ" }, type: 1 },
        { buttonId: `${prefix}owner`, buttonText: { displayText: "👤 ᴏᴡɴර්" }, type: 1 }
    ];
...
case 'owner': {
    try {
        const sanitized = (sender || '').replace(/[^0-9]/g, '');
        const cfg = await loadUserConfigFromMongo(sanitized) || {};
        const botName = cfg.botName || 'ʟɪᴛᴇ x';
        const prefix = config.PREFIX;
        ...
        const text = `
👑 *${botName.toUpperCase()} ᴏᴡɴᴇʀ ɪɴꜰᴏ* 👑
━━━━━━━━━━━━━━━━━━━━━━━━
...
💬 *ꜰොʀ ꜱᴜᴘᴘොʀᴛ ᴏʀ ǫᴜᴇʀɪᴇꜱ, ᴄොɴᴛᴀᴄᴛ ᴛʜᴇ ᴏᴡɴᴇʀ ᴅɪʀᴇᴄᴛʟʏ.*
...
`.trim();
        ...
        await socket.sendMessage(sender, {
            ...
            headerType: 4,
            viewOnce: true
        }, { quoted: shonux }); // Meta AI quote එක මෙතැනදී භාවිතා වේ
